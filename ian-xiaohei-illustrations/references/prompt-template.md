...
Generate each image separately. Replace the variables based on the article content, and do not combine multiple images into one.
...
Structure type:
{Workflow / System Detail / Before and After / Character States / Conceptual Metaphor / Method Layers / Map Route / Mini-Comic Sequence}

Core idea:
{the core idea this image should express}

Composition:
{where Xiaohei is, what Xiaohei is doing, the main object, and how information flows}
